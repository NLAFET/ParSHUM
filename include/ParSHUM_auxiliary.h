...
void   print_double_array(double *array, int n, char *mess);
void   update_counter(int *counter, int *index, int n, int base);
void   check_vlaid_perms(int *perms, int *invr_perms, int needed_pivots, int nb_pivots, char *name);
void   check_vect_doubles(int *vect, int n, char *name);
