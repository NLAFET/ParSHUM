...
void ParSHUM_collect_BB_block(double *local_schur, double *global_schur,  double **buff, col_block col_blocks,
			      row_block row_blocks, int m, int n, int BB_cols, int nb_threads, 
